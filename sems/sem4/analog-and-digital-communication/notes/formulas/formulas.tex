...
\begin{outline}
	\1 $\lambda = \frac{v}{f} \implies v = \lambda \cdot f$
	\1 Power gain or loss in dB $= 10 \log \left( \frac{P_2}{P_1} \right)$
	\2 $P_2$ = Measured or calculated power
	\2 $P_1$ = Reference power
	\1 Voltage gain or loss in dB $= 10 \log \left( \frac{V_2}{V_1} \right)$
	\1 dBm is dB level using 1-mW reference, i.e., $P_1 = 1\ \text{mW}$
	\1 Signal to Noise Ratio (SNR) $= \frac{S}{N} = \mathrm{\frac{Signal Power}{Noise Power}} = \frac{P_S}{P_N}$
	\1 SNR $= 10 \log \frac{P_S}{P_N}$
	\1 Noise Figure, NF $= 10 \log \frac{S_i /N_i}{S_o /N_o} = 10 \log (\text{NR or SNR})$
\end{outline}
...
\begin{outline}
	...
	We have, $\sin a \sin b = \frac{\cos(a - b) - \cos(a + b)}{2}$. Therefore,
